          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-start gap-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg mb-4 text-[#545454] text-justify">
                For homes, we craft sanctuaries that reflect your personality
                and adapt to your lifestyle. Imagine walls that change color
                with your mood, furniture that morphs for entertaining or
                relaxing, and smart systems that anticipate your needs before
                you do.
                <br />
                <br />
                Our office designs boost productivity through biophilic
                elements, create collaborative zones that spark innovation, and
                incorporate flexible layouts that evolve with your business,
                ensuring every corner contributes to employee well-being and
                company culture.
                <br />
                <br />
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-start gap-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg mb-4 text-[#545454] text-justify">
                ...
                efficiency with stunning aesthetics, tailored to your unique
          ...
          <div className=" relative z-10 flex flex-col lg:flex-row items-center lg:items-start gap-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg mb-6 text-[#545454] text-justify">
                ...
                <br />
                <br />
                Experience the perfect blend of color, texture, and
                craftsmanship as we bring your vision to life. Trust Br Interior
                to revitalize your space with precision, creativity, and
                unmatched expertise, making every wall a masterpiece.
              </p>
              <Link href="/contact">
                <button className="px-6 py-3 bg-[#1F1F1F] text-white rounded hover:bg-[#444444] text-sm sm:text-base md:text-lg w-fit mx-auto lg:mx-0">
                  Get in Touch
